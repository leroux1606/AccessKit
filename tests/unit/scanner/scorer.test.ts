...
const makeViolation = (severity: "CRITICAL" | "SERIOUS" | "MODERATE" | "MINOR") => ({
  ruleId: "test-rule",
  engine: "AXE_CORE" as const,
  severity,
...
describe("addPageScores", () => {
  ...
  it("does not mutate the original violations array", () => {
    ...
    const [result] = addPageScores([page]);
